"""
Django settings for RutasAndinas project.
...
SECRET_KEY = 'django-insecure-xzpoh4hb(x9#5n1_2jd9_x)nbjm@ciyg63-yj*pptv4-n4ap&@'
...
ROOT_URLCONF = 'RutasAndinas.urls'
...
WSGI_APPLICATION = 'RutasAndinas.wsgi.application'
